...
freqs_df = pd.DataFrame(freqs.keys())
freqs_df
...
freqs_df_pos = freqs_df[freqs_df[1]==1]
freqs_df_pos
...
len(freqs_df_pos[0].unique())


# In[49]:


freqs_df_neg = freqs_df[freqs_df[1]==0]
freqs_df_neg
...
len(freqs_df_neg[0].unique())


# In[65]:


freqs.get(('followfriday', 1.0))
...
np.average(np.array([1,2,2])-np.array([1,2,1]))
